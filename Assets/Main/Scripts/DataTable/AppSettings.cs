...
namespace AppSettings
{
    ...
    /// No use of generic and reflection, for better performance,  less IL code generating
	/// </summary>>
    public partial class InstanceTableSettings : IReloadableSettings
    {
        /// <summary>
        /// How many reload function load?
        /// </summary>>
        ...
        internal static InstanceTableSettings _instance = new InstanceTableSettings();
        Dictionary<int, InstanceTableSetting> _dict = new Dictionary<int, InstanceTableSetting>();
        ...
        /// </summary>
        /// <returns></returns>
	    public static InstanceTableSettings GetInstance()
	    {
            if (ReloadCount == 0)
            {
                _instance._ReloadAll(true);
        ...
        /// <summary>
        /// Do reload the setting file: InstanceTable, no exception when duplicate primary key
        /// </summary>
        public void ReloadAll()
        {
            _ReloadAll(false);
        ...
        /// <summary>
        /// Do reload the setting class : InstanceTable, no exception when duplicate primary key, use custom string content
        /// </summary>
        public void ReloadAllWithString(string context)
        {
            _ReloadAll(false, context);
        ...
        /// <summary>
        /// Do reload the setting file: InstanceTable
        /// </summary>
	    void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    foreach (var row in tableFile)
                    {
                        var pk = InstanceTableSetting.ParsePrimaryKey(row);
                        InstanceTableSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new InstanceTableSetting(row);
                            _dict[setting.Id] = setting;
                        }
                        else 
                        {
	    ...
	    /// <summary>
        /// foreachable enumerable: InstanceTable
        /// </summary>
        public static IEnumerable GetAll()
        {
            foreach (var row in GetInstance()._dict.Values)
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: InstanceTable
        /// </summary> 
	    public static IEnumerator GetEnumerator()
	    {
	        return GetInstance()._dict.Values.GetEnumerator();
	    ...
	    /// <summary>
        /// Get class by primary key: InstanceTable
        /// </summary>
        public static InstanceTableSetting Get(int primaryKey)
        {
            InstanceTableSetting setting;
            if (GetInstance()._dict.TryGetValue(primaryKey, out setting)) return setting;
            return null;
    ...
    /// Singleton class for less memory use
	/// </summary>
	public partial class InstanceTableSetting : TableRowFieldParser
	{
    ...
    /// No use of generic and reflection, for better performance,  less IL code generating
	/// </summary>>
    public partial class ModelTableSettings : IReloadableSettings
    {
        /// <summary>
        /// How many reload function load?
        /// </summary>>
        ...
        internal static ModelTableSettings _instance = new ModelTableSettings();
        Dictionary<int, ModelTableSetting> _dict = new Dictionary<int, ModelTableSetting>();
        ...
        /// </summary>
        /// <returns></returns>
	    public static ModelTableSettings GetInstance()
	    {
            if (ReloadCount == 0)
            {
                _instance._ReloadAll(true);
        ...
        /// <summary>
        /// Do reload the setting file: ModelTable, no exception when duplicate primary key
        /// </summary>
        public void ReloadAll()
        {
            _ReloadAll(false);
        ...
        /// <summary>
        /// Do reload the setting class : ModelTable, no exception when duplicate primary key, use custom string content
        /// </summary>
        public void ReloadAllWithString(string context)
        {
            _ReloadAll(false, context);
        ...
        /// <summary>
        /// Do reload the setting file: ModelTable
        /// </summary>
	    void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    foreach (var row in tableFile)
                    {
                        var pk = ModelTableSetting.ParsePrimaryKey(row);
                        ModelTableSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new ModelTableSetting(row);
                            _dict[setting.Id] = setting;
                        }
                        else 
                        {
	    ...
	    /// <summary>
        /// foreachable enumerable: ModelTable
        /// </summary>
        public static IEnumerable GetAll()
        {
            foreach (var row in GetInstance()._dict.Values)
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: ModelTable
        /// </summary> 
	    public static IEnumerator GetEnumerator()
	    {
	        return GetInstance()._dict.Values.GetEnumerator();
	    ...
	    /// <summary>
        /// Get class by primary key: ModelTable
        /// </summary>
        public static ModelTableSetting Get(int primaryKey)
        {
            ModelTableSetting setting;
            if (GetInstance()._dict.TryGetValue(primaryKey, out setting)) return setting;
            return null;
    ...
    /// Singleton class for less memory use
	/// </summary>
	public partial class ModelTableSetting : TableRowFieldParser
	{
	...
	/// <summary>
	/// Auto Generate for Tab File: "SoundTable.txt"
    /// No use of generic and reflection, for better performance,  less IL code generating
	/// </summary>>
    public partial class SoundTableSettings : IReloadableSettings
    {
        /// <summary>
        /// How many reload function load?
        /// </summary>>
        ...
        internal static SoundTableSettings _instance = new SoundTableSettings();
        Dictionary<int, SoundTableSetting> _dict = new Dictionary<int, SoundTableSetting>();
        ...
        /// </summary>
        /// <returns></returns>
	    public static SoundTableSettings GetInstance()
	    {
            if (ReloadCount == 0)
            {
                _instance._ReloadAll(true);
        ...
        /// <summary>
        /// Do reload the setting file: SoundTable, no exception when duplicate primary key
        /// </summary>
        public void ReloadAll()
        {
            _ReloadAll(false);
        ...
        /// <summary>
        /// Do reload the setting class : SoundTable, no exception when duplicate primary key, use custom string content
        /// </summary>
        public void ReloadAllWithString(string context)
        {
            _ReloadAll(false, context);
        ...
        /// <summary>
        /// Do reload the setting file: SoundTable
        /// </summary>
	    void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    foreach (var row in tableFile)
                    {
                        var pk = SoundTableSetting.ParsePrimaryKey(row);
                        SoundTableSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new SoundTableSetting(row);
                            _dict[setting.Id] = setting;
                        }
                        else 
                        {
	    ...
	    /// <summary>
        /// foreachable enumerable: SoundTable
        /// </summary>
        public static IEnumerable GetAll()
        {
            foreach (var row in GetInstance()._dict.Values)
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: SoundTable
        /// </summary> 
	    public static IEnumerator GetEnumerator()
	    {
	        return GetInstance()._dict.Values.GetEnumerator();
	    ...
	    /// <summary>
        /// Get class by primary key: SoundTable
        /// </summary>
        public static SoundTableSetting Get(int primaryKey)
        {
            SoundTableSetting setting;
            if (GetInstance()._dict.TryGetValue(primaryKey, out setting)) return setting;
            return null;
    ...
    /// Singleton class for less memory use
	/// </summary>
	public partial class SoundTableSetting : TableRowFieldParser
	{
	...
	/// <summary>
	/// Auto Generate for Tab File: "UIItemTable.txt"
    /// No use of generic and reflection, for better performance,  less IL code generating
	/// </summary>>
    public partial class UIItemTableSettings : IReloadableSettings
    {
        /// <summary>
        /// How many reload function load?
        /// </summary>>
        ...
        internal static UIItemTableSettings _instance = new UIItemTableSettings();
        Dictionary<int, UIItemTableSetting> _dict = new Dictionary<int, UIItemTableSetting>();
        ...
        /// </summary>
        /// <returns></returns>
	    public static UIItemTableSettings GetInstance()
	    {
            if (ReloadCount == 0)
            {
                _instance._ReloadAll(true);
        ...
        /// <summary>
        /// Do reload the setting file: UIItemTable, no exception when duplicate primary key
        /// </summary>
        public void ReloadAll()
        {
            _ReloadAll(false);
        ...
        /// <summary>
        /// Do reload the setting class : UIItemTable, no exception when duplicate primary key, use custom string content
        /// </summary>
        public void ReloadAllWithString(string context)
        {
            _ReloadAll(false, context);
        ...
        /// <summary>
        /// Do reload the setting file: UIItemTable
        /// </summary>
	    void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    foreach (var row in tableFile)
                    {
                        var pk = UIItemTableSetting.ParsePrimaryKey(row);
                        UIItemTableSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new UIItemTableSetting(row);
                            _dict[setting.Id] = setting;
                        }
                        else 
                        {
	    ...
	    /// <summary>
        /// foreachable enumerable: UIItemTable
        /// </summary>
        public static IEnumerable GetAll()
        {
            foreach (var row in GetInstance()._dict.Values)
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: UIItemTable
        /// </summary> 
	    public static IEnumerator GetEnumerator()
	    {
	        return GetInstance()._dict.Values.GetEnumerator();
	    ...
	    /// <summary>
        /// Get class by primary key: UIItemTable
        /// </summary>
        public static UIItemTableSetting Get(int primaryKey)
        {
            UIItemTableSetting setting;
            if (GetInstance()._dict.TryGetValue(primaryKey, out setting)) return setting;
            return null;
    ...
    /// Singleton class for less memory use
	/// </summary>
	public partial class UIItemTableSetting : TableRowFieldParser
	{
        ...
        internal UIItemTableSetting(TableFileRow row)
        {
            Reload(row);
        }
