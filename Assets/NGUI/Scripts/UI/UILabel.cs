...
public class UILabel : UIWidget
{
    ...
    [HideInInspector] [SerializeField] int mLocalizationId = 0;
    ...
    protected override void OnStart()
    {
        ...
        //本地化
        if (mLocalizationId != 0 && ResourceManager.TablePreloaded)
        {
            mText = I18N.Get(mLocalizationId);
        }
